...
namespace libuvc_camera
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(UVCCameraConfig &config, const UVCCameraConfig &max, const UVCCameraConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const UVCCameraConfig &config1, const UVCCameraConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, UVCCameraConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const UVCCameraConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, UVCCameraConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const UVCCameraConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const UVCCameraConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, UVCCameraConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<std::string>("video_mode", "str", 3, "Format of video stream from camera.", "{'enum': [{'name': 'uncompressed', 'type': 'str', 'value': 'uncompressed', 'srcline': 36, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'Use any uncompressed format', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'compressed', 'type': 'str', 'value': 'compressed', 'srcline': 37, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'User any compressed format', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'yuyv', 'type': 'str', 'value': 'yuyv', 'srcline': 38, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'YUYV', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'uyvy', 'type': 'str', 'value': 'uyvy', 'srcline': 39, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'UYVY', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'rgb', 'type': 'str', 'value': 'rgb', 'srcline': 40, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'RGB', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'bgr', 'type': 'str', 'value': 'bgr', 'srcline': 41, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'BGR', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'mjpeg', 'type': 'str', 'value': 'mjpeg', 'srcline': 42, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'MJPEG', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'gray8', 'type': 'str', 'value': 'gray8', 'srcline': 43, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'gray8', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Video stream format'}", &UVCCameraConfig::video_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<std::string>("timestamp_method", "str", 3, "Method for determining the timestamp.", "{'enum': [{'name': 'PubTime', 'type': 'str', 'value': 'pub', 'srcline': 53, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'Time of publication', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'FrameStartTime', 'type': 'str', 'value': 'start', 'srcline': 54, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'Time when raw frame capture began', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'FrameStopTime', 'type': 'str', 'value': 'stop', 'srcline': 55, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'Time when raw frame capture ended', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'HostReceiptTime', 'type': 'str', 'value': 'hostrcpt', 'srcline': 56, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'Time when camera-to-host transfer completed', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Methods for determining the timestamp'}", &UVCCameraConfig::timestamp_method)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<std::string>("timestamp_method", "str", 3, "Method for determining the timestamp.", "{'enum': [{'name': 'PubTime', 'type': 'str', 'value': 'pub', 'srcline': 53, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'Time of publication', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'FrameStartTime', 'type': 'str', 'value': 'start', 'srcline': 54, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'Time when raw frame capture began', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'FrameStopTime', 'type': 'str', 'value': 'stop', 'srcline': 55, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'Time when raw frame capture ended', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'HostReceiptTime', 'type': 'str', 'value': 'hostrcpt', 'srcline': 56, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'Time when camera-to-host transfer completed', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Methods for determining the timestamp'}", &UVCCameraConfig::timestamp_method)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.frame_id = "";
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.frame_id = "";
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.frame_id = "camera_rgb_optical_frame";
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<int>("scanning_mode", "int", 0, "Scanning mode.", "{'enum': [{'name': 'Interlaced', 'type': 'int', 'value': 0, 'srcline': 72, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': '', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Progressive', 'type': 'int', 'value': 1, 'srcline': 73, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': '', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Scanning modes'}", &UVCCameraConfig::scanning_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<int>("scanning_mode", "int", 0, "Scanning mode.", "{'enum': [{'name': 'Interlaced', 'type': 'int', 'value': 0, 'srcline': 72, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': '', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Progressive', 'type': 'int', 'value': 1, 'srcline': 73, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': '', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Scanning modes'}", &UVCCameraConfig::scanning_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<int>("auto_exposure", "int", 0, "Auto exposure mode.", "{'enum': [{'name': 'Manual', 'type': 'int', 'value': 0, 'srcline': 80, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'Manual exposure, manual iris', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Auto', 'type': 'int', 'value': 1, 'srcline': 81, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'Auto exposure, auto iris', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Shutter_Priority', 'type': 'int', 'value': 2, 'srcline': 82, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'manual exposure, auto iris', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Aperture_Priority', 'type': 'int', 'value': 3, 'srcline': 83, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'auto exposure, manual iris', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Auto-exposure modes'}", &UVCCameraConfig::auto_exposure)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<int>("auto_exposure", "int", 0, "Auto exposure mode.", "{'enum': [{'name': 'Manual', 'type': 'int', 'value': 0, 'srcline': 80, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'Manual exposure, manual iris', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Auto', 'type': 'int', 'value': 1, 'srcline': 81, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'Auto exposure, auto iris', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Shutter_Priority', 'type': 'int', 'value': 2, 'srcline': 82, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'manual exposure, auto iris', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Aperture_Priority', 'type': 'int', 'value': 3, 'srcline': 83, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'auto exposure, manual iris', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Auto-exposure modes'}", &UVCCameraConfig::auto_exposure)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<int>("power_line_frequency", "int", 0, "Power line frequency anti-flicker processing.", "{'enum': [{'name': 'Disabled', 'type': 'int', 'value': 0, 'srcline': 146, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'Disabled', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Freq_50', 'type': 'int', 'value': 1, 'srcline': 147, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': '50 Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Freq_60', 'type': 'int', 'value': 1, 'srcline': 148, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': '60 Hz', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Power line frequency modes'}", &UVCCameraConfig::power_line_frequency)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(UVCCameraConfig::AbstractParamDescriptionConstPtr(new UVCCameraConfig::ParamDescription<int>("power_line_frequency", "int", 0, "Power line frequency anti-flicker processing.", "{'enum': [{'name': 'Disabled', 'type': 'int', 'value': 0, 'srcline': 146, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': 'Disabled', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Freq_50', 'type': 'int', 'value': 1, 'srcline': 147, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': '50 Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Freq_60', 'type': 'int', 'value': 1, 'srcline': 148, 'srcfile': '/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg', 'description': '60 Hz', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Power line frequency modes'}", &UVCCameraConfig::power_line_frequency)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.auto_hue = 0;
...
//#line 36 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_uncompressed = "uncompressed";
//#line 37 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_compressed = "compressed";
//#line 38 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_yuyv = "yuyv";
//#line 39 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_uyvy = "uyvy";
//#line 40 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_rgb = "rgb";
//#line 41 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_bgr = "bgr";
//#line 42 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_mjpeg = "mjpeg";
//#line 43 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_gray8 = "gray8";
//#line 53 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_PubTime = "pub";
//#line 54 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_FrameStartTime = "start";
//#line 55 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_FrameStopTime = "stop";
//#line 56 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const char * const UVCCamera_HostReceiptTime = "hostrcpt";
//#line 72 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const int UVCCamera_Interlaced = 0;
//#line 73 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const int UVCCamera_Progressive = 1;
//#line 80 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const int UVCCamera_Manual = 0;
//#line 81 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const int UVCCamera_Auto = 1;
//#line 82 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const int UVCCamera_Shutter_Priority = 2;
//#line 83 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const int UVCCamera_Aperture_Priority = 3;
//#line 146 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const int UVCCamera_Disabled = 0;
//#line 147 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
      const int UVCCamera_Freq_50 = 1;
//#line 148 "/home/cona/catkin_ws/src/ros_astra_camera/cfg/UVCCamera.cfg"
