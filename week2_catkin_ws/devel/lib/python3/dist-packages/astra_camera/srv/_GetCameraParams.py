...
class GetCameraParamsResponse(genpy.Message):
  _md5sum = "ad6c16093abed8d06d93880396c17791"
...
"""
  __slots__ = ['l_intr_p','r_intr_p','r2l_r','r2l_t','l_k','r_k']
  _slot_types = ['float32[4]','float32[4]','float32[9]','float32[3]','float32[5]','float32[5]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       l_intr_p,r_intr_p,r2l_r,r2l_t,l_k,r_k
